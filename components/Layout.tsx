        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <button 
                onClick={() => setView(AppView.QUALIFIER)}
                className={`px-3 py-2 rounded-md text-[11px] font-black uppercase tracking-widest transition-all ${currentView === AppView.QUALIFIER ? 'bg-emerald-600/10 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/5'}`}
              >
                Qualificador
              </button>
              <button 
              ...
              <button 
                onClick={() => setView(AppView.PAYMENTS)}
              ...
              <button 
                onClick={() => setView(AppView.APPOINTMENTS)}
                className={`px-3 py-2 rounded-md text-[11px] font-black uppercase tracking-widest transition-all ${currentView === AppView.APPOINTMENTS ? 'bg-emerald-600/10 text-emerald-400' : 'text-slate-400 hover:text-white hover:bg-white/5'}`}
              >
                Compromissos
              </button>
              <button 
